...
class DBStorage:
    ...
    def get(self, cls, id):
        ...
        The object if it exists. None if cls or id is None or if the object does not exist.
        """
    ...
    def count(self, cls=None):
        ...
        Returns:
            The object if it exists. If cls is None, the total number of objects stored is returned.
        """
        count = 0
        for clss in classes:
